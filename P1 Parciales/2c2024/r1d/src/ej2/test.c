...
void do_test_a(
	...
	if (has_differences(filepath_expected, dst, out_size)) {
		printf(FAIL "do_test(\"%s\", \"%s\")\n", filepath_dst, filepath_src);
...
int main(int argc, char* argv[]) {
	...
	if (!EJERCICIO_2A_HECHO) {
		...
		do_test_a("expected/002-sepia.png", "outputs/002-sepia.png",       "img/002-square.jpg");
		do_test_a("expected/003-sepia.png", "outputs/003-sepia.png",       "img/003-square.jpg");
		do_test_a("expected/012-sepia.png", "outputs/012-sepia.png",       "img/012-square.jpg");
		do_test_a("expected/017-sepia.png", "outputs/017-sepia.png",       "img/017-square.jpg");
